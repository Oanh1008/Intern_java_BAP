...
public interface BookingRepository extends JpaRepository<Booking,Integer> {
    ...
    @Query("select (count(b )> 0) from Booking  b where b.room.roomCode = ?1 and b.endTime > ?2 and b.startTime < ?3 and (b.bookingState <> 'Canceled' and b.bookingState <> 'Completed') ")
